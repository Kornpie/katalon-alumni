...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_register-software/input__password'), 'HeCM15nHKBI=')
...
WebUI.setText(findTestObject('Object Repository/Page_register-software/input__Province-work'), 'นครปฐม')
