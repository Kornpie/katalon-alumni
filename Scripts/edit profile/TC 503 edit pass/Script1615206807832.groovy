...
WebUI.setText(findTestObject('Object Repository/Page_/input__idstd'), '614259041')
...
WebUI.click(findTestObject('Object Repository/Page_Show-user/a__1'))

WebUI.click(findTestObject('Object Repository/Page_Document/input__fname'))

WebUI.setText(findTestObject('Object Repository/Page_Document/input__job'), 'รับจ้าง')

WebUI.click(findTestObject('Object Repository/Page_Document/button_'))

WebUI.verifyTextPresent('รับจ้าง', false)
